...
dt0 = dt.datetime(year=2021, month=2, day=28)
dt1 = dt.datetime(year=2023, month=4, day=4)
#
...
#new_delta  = dt.datetime(year=2023, month=4, day=4)
#print(new_delta) 
...
y=x.strftime('%A of the week number %U of the year %Y')
print(y)
